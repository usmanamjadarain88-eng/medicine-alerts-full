r"""
Quick test that API + DB are working.
Run from repo root (medicine-alerts) with server ALREADY running in another terminal:

  backend\set_database_url.bat
  python test_api.py

This script only sends HTTP requests. It does NOT start the server.
"""
import json
import os
import sys
